# Generated by Powerlevel10k configuration wizard on 2020-12-04 at 08:37 EST.
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}${(g::)__GIT_UNSTAGED_ICON}${VCS_STATUS_NUM_UNSTAGED}"
